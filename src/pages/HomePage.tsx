...
const NAV_TILES: NavTile[] = [
  ...
  },
  {
    to: "/health",
    title: "Health record",
    description: "Manage your allergies, active therapies, and family members' health profiles.",
    icon: Activity,
  ...
  },
  {
    ...
    description: "See which pharmacies stock a product so you can pick it up locally.",
    icon: Building2,
  ...
  },
  {
    to: "/reservations",
    title: "Reservations",
    description: "View and manage your product reservations at local pharmacies.",
    icon: Calendar,
